...
На рисунке 14 представлен результат работы и выполнения запросов.

  ![alt text](img/Рисунок14.png)

Рисунок 14. Результат выполнения запроса /get info vehicle
